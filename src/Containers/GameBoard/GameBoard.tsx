...
export default class GameBoard extends React.Component<GameBoardProps, GameBoardState> {
  ...
  state = {
    board:  [
      ...
      { key: {row: 1, col: 5}, value: Occupied.Empty }, 
      { key: {row: 2, col: 1}, value: Occupied.Empty },
      { key: {row: 2, col: 2}, value: Occupied.Empty }, 
      { key: {row: 2, col: 3}, value: Occupied.Empty }, 
      { key: {row: 2, col: 4}, value: Occupied.PlayerTwo },
      { key: {row: 2, col: 5}, value: Occupied.Empty },
      ...
      { key: {row: 3, col: 5}, value: Occupied.Empty },
      { key: {row: 4, col: 1}, value: Occupied.Empty },
      { key: {row: 4, col: 2}, value: Occupied.PlayerOne },
      { key: {row: 4, col: 3}, value: Occupied.Empty },
      { key: {row: 4, col: 4}, value: Occupied.Empty },
      { key: {row: 4, col: 5}, value: Occupied.Empty },
      ...
      { key: {row: 5, col: 5}, value: Occupied.Empty },
    ],
    currentTile: null,
  };
